...
var ReactPlanner = function (_Component) {
  ...
  _createClass(ReactPlanner, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var selected = extractedState.getIn(["scene", "layers", selectedLayer, "selected"]) || _immutable2.default.Map();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !disableToolBar && _react2.default.createElement(Toolbar, _extends({
          width: toolbarW,
          height: toolbarH,
        ...
        !disableSideBar && selected && _react2.default.createElement(Sidebar, _extends({
          width: sidebarW,
          height: sidebarH,
          state: extractedState
        }, props)),
        !disableFooterBar && _react2.default.createElement(FooterBar, _extends({
          width: width,
          height: footerBarH,
          state: extractedState
        }, props))
